...
!---------------------------------------------------------------
!Begins by calculating all fractional atomic positions - 
! including multiple atoms in the same location when atoms are in a special
! position of the spacegroup
!---------------------------------------------------------------
