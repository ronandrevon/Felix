...
MODULE refinementcontrol_mod
  ...
  SUBROUTINE Simulate(IErr)
    ...
    INTEGER(IKIND) :: IErr, ind,jnd,knd,pnd,k,IIterationFLAG
!    REAL(RKIND),DIMENSION(:,:),ALLOCATABLE :: RTempImage
    ...
    ILocalPixelCountMin=1000
    DO knd = ILocalPixelCountMin,ILocalPixelCountMin,1
