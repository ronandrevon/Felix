...
MODULE CConst
  ...
  CHARACTER*30, PARAMETER :: RStr= "Version :tinis3a:, Build :1:"
  CHARACTER*30, PARAMETER :: DStr= "Date :21 August 2016:"
  CHARACTER*30, PARAMETER :: AStr= "Status :in test:, Author :RB:"
